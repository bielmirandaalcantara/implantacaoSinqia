...
namespace Sinqia.CoreBank.DAO.Corporativo.Services.SqlServer
{
    public class tb_grpempDaoSqlServer : IDao<tb_grpemp>
    {
        ...
        public tb_grpempDaoSqlServer(ConfiguracaoBaseDataBase dataBaseConfig, LogService log, IDaoTransacao transacao = null)
        {
            _log = log;
        ...
        public tb_grpemp ObterPrimeiro(string where)
        {
            _log.TraceMethodStart();
