...
{
    public class MsgPessoaConsulta
    {
        /// <summary>
        /// header da mensagem
        ...
        /// </summary>
        public MsgRegistroPessoaConsultaBody body { get; set; }
    }

    public class MsgRegistroPessoaConsultaBody
    {
        public MsgRegistropessoaConsulta[] RegistroPessoa { get; set; }
    }
    ...
    /// </summary>
    public class MsgRegistropessoaConsulta : MsgRegistropessoa
    {
        /// <summary>
        /// inclusão de perfil
        /// </summary>
