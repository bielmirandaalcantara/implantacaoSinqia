...
namespace Sinqia.CoreBank.Services.CUC.Models
{
    ...
    public class DataSetPessoaSimplificada
    {
        [System.Xml.Serialization.XmlElementAttribute("RegistroPessoaSimplificada")]
        public DataSetPessoaSimplificadaPessoaSimplificada[] RegistroPessoaSimplificada { get; set; }
    }

    [System.SerializableAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public class DataSetPessoaSimplificadaPessoaSimplificada
    {
